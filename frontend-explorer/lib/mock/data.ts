...
function build(s: AssetSeed): Asset {
  ...
  return {
    ...
    // Real per-asset coverage locked at vouch (§3.5 note 2) — stored, not
    // recomputed in the page (audit G8). 0 before a vouch exists.
    coverageLocked:
      s.state === "PENDING_VOUCH" || s.state === "CANCELLED"
        ? 0
        : Math.round((s.fundingGoal * 2000) / 10000),
    raiseSeries,
    indexSeries,
    wrapSeries,
...
export const assets: Asset[] = [
  ...
  build({
    id: "asset11",
    name: "Kigali Logistics Park",
    ticker: "KLP",
    entity: "0x4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f607182930",
    entityName: "Rwanda Inland Ports",
    category: "Infrastructure",
    state: "FUNDED",
    blurb:
      "Bonded warehousing & dry-port handling at the Kigali special economic zone. Raise just finalized; tranche engine armed, first milestone pending.",
    location: "Kigali, Rwanda",
    fundingGoal: 2_200_000,
    raised: 2_200_000,
    fundingDeadlineMs: NOW - 6 * DAY,
    createdAtMs: NOW - 44 * DAY,
    tranches: [
      tranche(0, 900_000, "Site grading & bonded warehouse shell", NOW + 40 * DAY, false),
      tranche(1, 800_000, "Handling equipment & weighbridge", NOW + 95 * DAY, false),
      tranche(2, 500_000, "Customs IT & commissioning", NOW + 150 * DAY, false),
    ],
    entityCollateral: 220_000,
    revenueSplitBps: 6800,
    validatorPoolId: CONTINENTAL,
    contributors: 308,
    holders: 296,
  ...
  build({
    id: "asset12",
    name: "Lusaka Maize Storage",
    ticker: "LMS",
    entity: "0x5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293041",
    entityName: "Zambezi Grain Holdings",
    category: "Agriculture",
    state: "DEFAULTED",
    blurb:
      "Silo complex for smallholder maize aggregation. Entity missed the second tranche deadline — default flagged; collateral and residual escrow seized into compensation.",
    location: "Lusaka, Zambia",
    fundingGoal: 1_050_000,
    raised: 1_050_000,
    fundingDeadlineMs: NOW - 165 * DAY,
    createdAtMs: NOW - 205 * DAY,
    tranches: [
      tranche(0, 420_000, "Silo civil works", NOW - 140 * DAY, true, CONTINENTAL),
      tranche(1, 420_000, "Aeration & handling plant", NOW - 18 * DAY, false, CONTINENTAL),
      tranche(2, 210_000, "Grading & commissioning", NOW + 30 * DAY, false),
    ],
    entityCollateral: 157_500,
    revenueSplitBps: 6600,
    validatorPoolId: CONTINENTAL,
    contributors: 241,
    holders: 233,
    seed: 1212,
  ...
  build({
    id: "asset13",
    name: "Freetown Market Refit",
    ticker: "FMR",
    entity: "0x6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f607182930415c",
    entityName: "Sierra Urban Renewal",
    category: "Infrastructure",
    state: "CANCELLED",
    blurb:
      "Covered-market modernization. No validator vouched the legals within the timeout window, so the listing was cancelled and the entity's collateral returned.",
    location: "Freetown, Sierra Leone",
    fundingGoal: 700_000,
    raised: 0,
    fundingDeadlineMs: NOW + 40 * DAY,
    createdAtMs: NOW - 38 * DAY,
    tranches: [
      tranche(0, 420_000, "Structural refit", NOW + 70 * DAY, false),
      tranche(1, 280_000, "Stalls & utilities", NOW + 130 * DAY, false),
    ],
    entityCollateral: 105_000,
    revenueSplitBps: 6500,
    validatorPoolId: TRUSTBRIDGE,
    contributors: 0,
    holders: 0,
